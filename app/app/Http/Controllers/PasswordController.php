...
use App\Repositories\Eloquents\UserTokenRepositoryInterface;
...
class PasswordController extends Controller
{
    ...
    {
    return view('user.reset_password.pass');
    }
    ...
    {   
        try {
            ...
            return redirect()->route('password_reset.pass')
        ...
        return redirect()->route('password_reset.email.send_comp');
    ...
    public function update(ResetPasswordRequest $request)
    {
        ...
        return redirect()->route('password_reset.pass_comp');
    }
